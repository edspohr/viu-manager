...
- materialId: best match from this list:
${materialList}
- materialName: matched material name
...
Schema: { "campaignName": string, "items": ExtractedItem[], "requiresInstallation": boolean, "notes": string }`;
